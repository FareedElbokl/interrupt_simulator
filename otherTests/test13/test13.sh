...
./interrupts otherTests/test13/trace13.txt

# Move the generated execution.txt to test3/execution3.txt
mv execution.txt otherTests/test13/execution13.txt

# Notify the user that the test is complete
echo "Test 13 completed. Check otherTests/test13/execution13.txt for the output."
