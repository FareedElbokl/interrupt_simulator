...
./interrupts otherTests/test4/trace4.txt

# Move the generated execution.txt to test3/execution3.txt
mv execution.txt otherTests/test4/execution4.txt

# Notify the user that the test is complete
echo "Test 4 completed. Check otherTests/test4/execution4.txt for the output."
