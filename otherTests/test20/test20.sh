...
./interrupts otherTests/test20/trace20.txt

# Move the generated execution.txt to test3/execution3.txt
mv execution.txt otherTests/test20/execution20.txt

# Notify the user that the test is complete
echo "Test 20 completed. Check otherTests/test20/execution20.txt for the output."
