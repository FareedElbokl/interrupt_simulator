...
./interrupts otherTests/test7/trace7.txt

# Move the generated execution.txt to test3/execution3.txt
mv execution.txt otherTests/test7/execution7.txt

# Notify the user that the test is complete
echo "Test 7 completed. Check otherTests/test7/execution7.txt for the output."
