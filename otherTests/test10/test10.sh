...
./interrupts otherTests/test10/trace10.txt

# Move the generated execution.txt to test3/execution3.txt
mv execution.txt otherTests/test10/execution10.txt

# Notify the user that the test is complete
echo "Test 10 completed. Check otherTests/test10/execution10.txt for the output."
