...
./interrupts otherTests/test19/trace19.txt

# Move the generated execution.txt to test3/execution3.txt
mv execution.txt otherTests/test19/execution19.txt

# Notify the user that the test is complete
echo "Test 19 completed. Check otherTests/test19/execution19.txt for the output."
